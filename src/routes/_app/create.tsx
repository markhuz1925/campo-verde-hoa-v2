    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
          Transform your imagination into stunning videos with our advanced AI
          technology. Simply describe what you want to see, and watch it come to
          life.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-16">
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground">
            Advanced AI technology creates stunning videos from simple text
            descriptions
          </p>
        </div>
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground">
            Generate high-quality videos in seconds, not hours
          </p>
        </div>
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground">
            Export your videos in multiple formats and resolutions
          </p>
        </div>
      </div>
    </div>
